...
#   end
tasks = [ {:task_id=>"TASK-8782", :title=>"You can't compress the program without quantifying the open-source SSD pixel!", :status=>"In Progress", :priority=>"Medium"}, 
     ...
     {:task_id=>"TASK-1138", :title=>"Generating the driver won't do anything, we need to quantify the 1080p SMTP bandwidth!", :status=>"In Progress", :priority=>"Medium"},
